...
<head>
    ...
    <script src="https://kit.fontawesome.com/09bcd3baf7.js" crossorigin="anonymous"></script>
...
<body >
    <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="{{url('admin/dashboard')}}">
                            <img src="{{asset('admin_assets/images/icon/abc.png')}}" width="30%" alt="CoolAdmin" />
                        </a>
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="@yield('brand_select')">
                            <a href="{{url('admin/brand')}}">
                                <i class="	fa fa-bitcoin"></i>Brand</a>
                            
                        </li>
                        <li class="@yield('tax_select')">
                            <a href="{{url('admin/tax')}}">
                                <i class="	fa fa-percentage"></i>Tax</a>
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="{{url('admin/dashboard')}}">
                    <img src="{{asset('admin_assets/images/icon/abc.png')}}" alt="Cool Admin" />
                </a>
            </div>
                            ...
                            <div class="header-button">
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="{{ asset('images/icon/abc.png') }}"  />
                                        </div>
                                        <div class="content">
